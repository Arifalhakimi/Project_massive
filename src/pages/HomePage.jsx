...
import HeroImage from "../assets/img/bgberanda.png";
          ...
          <Row className='header-box d-flex align-items-center pt-lg-5'>
            <Col lg="6">
              <div className='text-container'>
                <h1 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s mt-4'>
                  Servis kendaraanmu dimana pun dan kapan pun dengan <span>Bengkel.in! </span>
                </h1>
