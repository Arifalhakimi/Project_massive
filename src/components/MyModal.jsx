    ...
    return (
        <Modal show={show} onHide={handleClose} className='modal-container '>
            <Modal.Header closeButton >
                <Modal.Title className='text-center'>{isLoginForm ? 'Login' : 'Register'}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                    ...
                    {isLoginForm ? (
                        ...
                        <>
                            ...
                            <Form.Group controlId="formBasicPhoneNumber" className='pt-3'>
                                <Form.Control type="tel" placeholder="Enter phone number" name="phoneNumber" required />
                            </Form.Group>
                        </>
                    )}

                    <Form.Group controlId="formBasicPassword" className='password pt-3 pb-3 '>
                        <Form.Control type="password" placeholder="Password" name="password" required />
                    </Form.Group>
                    <Button variant="primary" type="submit" className='btn-submit w-100 d-flex text-center'>
